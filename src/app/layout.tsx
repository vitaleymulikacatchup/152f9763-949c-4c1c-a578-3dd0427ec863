...
export const metadata: Metadata = {
  title: "One Game - Premium Toy Store & Games",
  description: "Discover quality toys, games, and gifts for all ages at One Game. Premium selection, trusted brands, and expert staff.",
  keywords: "toy store, games, toys for kids, quality toys, game store",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "One Game - Premium Toy Store",
    description: "Explore our curated collection of toys and games for children of all ages.",
    siteName: "One Game",
    type: "website"
  },
  twitter: {
    ...
    title: "One Game - Premium Toy Store",
    description: "Quality toys and games for kids of all ages"
  }
};
